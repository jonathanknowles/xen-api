...
let _ =
  ...
  error Api_errors.could_not_find_network_device_with_specified_mac_address [ "device"; "mac" ]
    ~doc:"Could not find a network device with the specified MAC address." ();
